...
<head>
    <meta charset="UTF-8"/>
    <title>Car Trade Value - Ultimate Booking System</title>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Car Trade Value</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
