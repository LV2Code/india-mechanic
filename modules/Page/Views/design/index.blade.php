...
@section('content')
	...
	<section class="b-featured">
		<div class="container">
			<h1 class="s-title wow zoomInUp" data-wow-delay="0.3s">Best Car Repair Services</h1>
			<div id="carousel-small" class="owl-carousel enable-owl-carousel" data-items="3" data-navigation="true" data-auto-play="true" data-stop-on-hover="true" data-items-desktop="3" data-items-desktop-small="3" data-items-tablet="4" data-items-tablet-small="4">
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
				<a href="car-servicing"><img class="img-responsive" src="{{asset('/design/media/services/car-servicing.webp')}}" alt="Car Servicing" /></a>
						...
						<h2 style="font-size: 25px"><a href="car-servicing">Car Servicing</a></h2>
				...
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
		<a href="car-dent-paint"><img class="img-responsive" src="{{asset('/design/media/services/dent-paint.webp')}}" alt="Car Denting Painting" /></a>
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px"><a href="car-dent-paint">Car Denting Painting</a></h2>
						 <div class="b-featured__item-price">
							Starts From : @ 1999*
						</div>
						<div class="col-sm-3 col-xs-12">
						<a href="car-dent-paint" class="btn m-btn">View Packages<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
				</div>
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
		<a href="car-cleaning"><img class="img-responsive" src="{{asset('/design/media/services/car-cleaning.webp')}}" alt="Car Cleaning" /></a>
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px"><a href="car-cleaning">Car Cleaning</a></h2>
						 <div class="b-featured__item-price">
							Starts From : @ 199*
						</div>
						<div class="col-sm-3 col-xs-12">
						<a href="car-cleaning" class="btn m-btn">View Packages<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
				</div>
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
						<img class="img-responsive" src="{{asset('/design/media/services/wheel-care.webp')}}" alt="Car Wheel Care" />
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px">Car Wheel Care</h2>
						 <div class="b-featured__item-price">
							Starts From : @ 149*
						</div>
						<div class="col-sm-3 col-xs-12">
						<a href="wheel-care" class="btn m-btn">View Packages<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
				</div>
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
						<img class="img-responsive" src="{{asset('/design/media/services/ac services.webp')}}" alt="Car Ac Services" />
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px">Car AC Services</h2>
						 <div class="b-featured__item-price">
							Starts From : @ 999*
						</div>
						<div class="col-sm-3 col-xs-12">
						<a data-toggle="modal" data-target="#ContactModal" class="btn m-btn">Get Quote<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
				</div>
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
						<img class="img-responsive" src="{{asset('/design/media/services/car-repair.webp')}}" alt="wolks" />
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px">Car Repair</h2>
						 <div class="col-sm-3 col-xs-12">
						<a data-toggle="modal" data-target="#ContactModal" class="btn m-btn">Get Quote<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
				...
				<div>
					<div class="b-world__item wow zoomInLeft" data-wow-delay="0.3s" data-wow-offset="100">
						<img class="img-responsive" src="{{asset('/design/media/services/insurance.webp')}}" alt="wolks" />
						<div class="b-world__item-val">
							<div class="b-world__item-val-circles">
								<span></span>
								<span></span>
						...
						<h2 style="font-size: 25px">Insurance Renewal</h2>
						  <div class="col-sm-3 col-xs-12">
						<a  data-toggle="modal" data-target="#ContactModal" class="btn m-btn">Get Quote<span class="fa fa-angle-right"></span></a>
					</div>
					</div>
